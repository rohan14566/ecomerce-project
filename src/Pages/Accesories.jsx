...
const Accesories = () => {
    const [accesoriescard,setAccesoriescard]=useState()

  useEffect(()=>{
  fetch('https://backend-mongo-eco.vercel.app/accesories')
  .then(res=>res.json())
  .then(json=>setAccesoriescard(json))
 ...
 <div className='top-bar'>
    ...
    <span className='icon2'><AiOutlineHome className='home'/><span className='icon-name1'>2 item $998</span></span>
...
<div className="table-box">
 ...
 <p> Siemen &nbsp; &nbsp;&nbsp; &nbsp;4</p>
    ...
    {
      accesoriescard && accesoriescard.map((item)=>{
        return(
